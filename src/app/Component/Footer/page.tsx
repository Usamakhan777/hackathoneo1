      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:gap-12 gap-8 z-20 relative">
          <div>
            ...
            <ul className="space-y-5">
              <li><a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base inline-flex items-center transition-all"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round" className="inline mr-1.5 h-4 w-4 shrink-0">
        ...
        <div className="flex flex-wrap sm:justify-between gap-6 relative z-20">
          <div className="flex space-x-5">
            <a href="javascript:void(0)" className="text-gray-400 hover:text-white text-base inline-transition-all">
          ...
          <p className='text-gray-400 text-sm'>© Muhammad Usama. All rights reserved
          </p>
        </div>
