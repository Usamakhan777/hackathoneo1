    ...
    <header className='flex shadow-lg py-4 px-4 sm:px-10 bg-white font-[sans-serif] min-h-[70px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center justify-between gap-4 w-full'>
        <a href="javascript:void(0)"
          className="lg:absolute max-lg:left-5 lg:top-2/4 lg:left-2/4 lg:-translate-x-1/2 lg:-translate-y-1/2"><img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOkeLcOaPcdD-Vas8ISlTa6JTcJ_FzDWvncA&s" alt="logo" className='w-36' />
        </a>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'>
              <a href='javascript:void(0)'
                className='hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'><Link href="/">Home</Link></a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'><Link href="/Team">Team</Link></a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'><Link href="/Servises">Servises</Link></a>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
              className='hover:text-[#007bff] text-[#333] block font-semibold text-[15px]'><Link href="/Contact">Contact</Link></a>
            </li>
          </ul>
        </div>
